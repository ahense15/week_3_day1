...
number4 = 123.33
number5 = 4555
print(" I was born in " + str(date_of_birth) + " i have " + str(number2) + " cats, but i want " + str(number5))

print(f"the date of birth is {date_of_birth} and the number is {number2}")
...
print(num1 * num2)
# # find the max number
print("The max number of 6 and 7 is",max(6,7))
# # find the remainder of the numbers
print ("The remainder of 10/3 is" ,(10%3))
# #round one number
print("5.6 rounded is", round(5.6))
